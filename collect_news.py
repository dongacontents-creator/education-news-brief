...
DOMAIN_MAP = {
    ...
    "jjan.kr": "전라일보", "suwonilbo.kr": "수원일보",
    "ccnnews.co.kr": "CCN뉴스",
    "cctoday.co.kr": "충청투데이", "cnbizm.com": "문화경제",
    "gnnews.co.kr": "경남일보", "sjbnews.com": "새전북신문",
    "ujeil.com": "울산제일일보", "4th.kr": "포쓰저널",
    "mhj21.com": "문화저널21", "public25.com": "퍼블릭타임스",
    "socialvalue.kr": "소셜밸류", "todayenergy.kr": "투데이에너지",
    "theopiniontimes.news": "더오피니언타임즈",
...
1. edu_type: 아래 우선순위로 정확히 하나 선택
   ...
   ④ AI·디지털교육 기술·플랫폼·에듀테크 활용·AI 도입 중심 기사: AI동향
      (교육부·교육청이 언급되더라도 기사 초점이 AI기술/플랫폼/에듀테크이면 AI동향)
   ⑤ 위 어디에도 해당 없으면: 교육부
   ※ edu 힌트가 AI동향이면 ④를 최우선으로 적용
   ※ edu 힌트가 특정 교육청/교육부면 ①②를 최우선 참고 (단, AI동향 힌트가 있으면 AI동향 우선)
